...
contract BarnBridgeProtocol is IDefiProtocol, OwnableUpgradeable, AbstractDependant {
    ERC20 public override stablecoin;
    address public yieldGeneratorAddress;

    modifier onlyYieldGenerator() {
        require(_msgSender() == yieldGeneratorAddress, "BP: Not a yield generator contract");
        _;
    }

    function __BarnBridgeProtocol_init() external initializer {
        __Ownable_init();
    }
