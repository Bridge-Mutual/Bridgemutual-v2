...
Dev 
## Signature setTotalLiquidity(uint256)
## `setTotalLiquidity(uint256 _stblInThePoolTotal)` (external)
*Params**

**Returns**
-----
# Function setTotalCoverTokens

Dev 
## Signature setTotalCoverTokens(uint256)
## `setTotalCoverTokens(uint256 _stblInThePoolBought)` (external)
*Params**
...
Dev 
## Signature setWhitelistedStatus(bool)
## `setWhitelistedStatus(bool status)` (external)
*Params**
