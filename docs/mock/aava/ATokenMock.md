...
## `constructor(address _usdt, uint256 _liquidityIndex)` (public)
*Params**
...
## `mint(address _user, uint256 _amount, uint256 index)` (public)
*Params**
...
## `burn(address _user, address receiverOfUnderlying, uint256 _amount, uint256 index)` (external)
*Params**
...
Dev 
## Signature setLiquidityIndex(uint256)
## `setLiquidityIndex(uint256 _liquidityIndex)` (external)
*Params**
...
Dev 
## Signature setPool(address)
## `setPool(address _pool)` (external)
*Params**
