...
## `setPricePerShare(uint256 pricePerShare_)` (public)
*Params**
...
## `deposit(uint256 amount) → uint256 issuedShares` (external)
*Params**
...
## `withdraw(uint256 shares, address pool) → uint256 value` (external)
*Params**
...
Dev 
## Signature burn(address,address,uint256)
## `burn(address account, address pool, uint256 shares) → uint256 value` (internal)
*Params**
...
## `mintInterest(address account)` (external)
*Params**
