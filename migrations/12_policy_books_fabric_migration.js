...
const UserLeveragePoolImpl = artifacts.require("UserLeveragePool");
const PolicyBookFacadeImpl = artifacts.require("PolicyBookFacade");
...
module.exports = async (deployer) => {
  ...
  await deployer.deploy(PolicyBookFacadeImpl);
  await deployer.deploy(UserLeveragePoolImpl);
